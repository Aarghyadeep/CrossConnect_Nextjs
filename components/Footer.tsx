...
export default function Footer() {
  return (
    <footer className="bg-[#0C0404] text-white flex flex-col">

    <div className="flex md:flex-row flex-col md:gap-0 gap-8 justify-between p-10">
    <Link href="/" className="flex items-center gap-1">
      <Image src="/Logo.png" height={30} width={30} alt="logo" />
      <p className="text-xl font-bold">CrossConnect</p>
    </Link>
    ...
    <ul className="flex gap-4 items-center">
      ...
      <hr className="border-t-[1px] border-solid border-gray-600" />
